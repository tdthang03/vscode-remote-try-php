...
<!-- Mirrored from diamant.kwst.net/site/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Jun 2024 07:14:36 GMT -->
<head>
        <!--=============== basic  ===============-->
        <meta charset="UTF-8">
            ...
            <header class="main-header">
                <div class="container">
                    ...
                    <div class="header-top  fl-wrap">
                        <div class="header-top_contacts"><a href="#"><span>Số điện thoại:</span> +888889999</a><a href="#"><span>Liên hệ:</span> Đại học Phenikaa</a></div>
...
<<<<<<< HEAD
                            <nav>
                                <ul>
                                    <li>
                                        <a class="fas fa-caret-down"><span>Account: </span><span>{{Auth::user()->name}}</span></a>
                                        <!--second level -->
                                        <ul>
                                            <li><a href="index.html"><i class="fa-regular fa-user"></i> Người dùng</a></li>
...
=======
                            ...
                            <nav>
                                <ul>
                                    <li>
                                        <a href="" class="fas fa-caret-down"><i class="fa-regular fa-user"><span></i> {{Auth::user()->name}}</span><i class="fas fa-caret-down"></i></a>
                                        <!--second level -->
                                        <ul>
...
=======
                            ...
                            <nav>
                                <ul>
                                    <li>
                                        <a href="{{Route('login_sign-up')}}" class="fas fa-caret-down"><i class="fa-regular fa-user"><span></i> login</span></a>
                                        <!--second level -->
                                        <!--second level end-->
                                    </li>
                                </ul>
                        ...
                        <div class="swiper-wrapper" >
                            ...
                            <div class="swiper-slide">
                                <div class="fs-slider-item hidden-content">
                                    <div class="bg"  data-bg="{{ asset('assets') }}/images/bg/22.jpg" data-swiper-parallax="40%"></div>
                                    ...
                                    <div class="hero-title-container">
                                        <div class="section-title">
                                            ...
                                            <a href="#sec2" class="stg_link custom-scroll-link">Khám phá</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="fs-slider-item hidden-content">
                                    <div class="bg"  data-bg="{{ asset('assets') }}/images/bg/15.jpg" data-swiper-parallax="40%"></div>
                                    ...
                                    <div class="hero-title-container">
                                        <div class="section-title">
                                            ...
                                            <div class="section-separator"><span><i class="fa-thin fa-gem"></i></span></div>
                                            <a href="{{ Route('rooms') }}" class="stg_link custom-scroll-link">View Our Rooms</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="fs-slider-item hidden-content">
                                    <div class="bg"  data-bg="{{ asset('assets') }}/images/bg/16.jpg" data-swiper-parallax="40%"></div>
                                    <div class="overlay"></div>
                                    <div class="hero-title-container">
                                        <div class="section-title">
                                            <h4>Hãy tận hưởng thời gian của bạn tại khách sạn.</h4>
                                            ...
                                            <div class="section-separator"><span><i class="fa-thin fa-gem"></i></span></div>
                                            <a href="{{ Route('rooms') }}" class="stg_link custom-scroll-link">Thông tin Phòng</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="content">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="text-block tb-sin">
                                    ...
                                    <a href="{{ Route('about') }}" class="btn fl-btn ">Tìm hiểu về chúng tôi</a>
                            ...
                            <div class="col-lg-6">
                                <div class="hero-image-collge-wrap">
                                    <div class="single-dec_img">
                                        <img src="{{ asset('assets') }}/images/all/11.jpg" alt="" class="respimg">
                                    </div>
                                    <div class="hero_images-collage-item" style="width: 25%; bottom:  25px; z-index: 15; left: -70px;"><img src="{{ asset('assets') }}/images/all/12.jpg" class="respimg" alt=""></div>
                                    <div class="hero_images-collage-item" style="width: 45%; top: -5%; z-index: 11; right: -120px;"><img src="{{ asset('assets') }}/images/all/7.jpg" class="respimg" alt=""></div>
                    ...
                    <div class="row">
                        <div class="st-gallery">
                            <div class="section-title">
                                ...
                                <a href="{{ Route('rooms') }}" class="stg_link">View All Rooms</a>	
                            </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="rooms-carousel-item full-height">
                                                    <div class="bg-wrap bg-parallax-wrap-gradien fs-wrapper">
                                                        <div class="bg" data-bg="{{ asset('storage/images') }}/{{$item->image}}" data-swiper-parallax="10%"></div>
                                                    </div>
                ...
                <div class="content-section">
                    <div class="container">
                        ...
                        <a href="{{ Route('contact') }}"   class="dwonload_btn">Get In touch With Us</a>
                        <div class="sc-dec" style="left: -220px; bottom: -100px;"></div>
                ...
                <div class="content-section dark-bg hidden-section  wide-section" data-scrollax-parent="true">
                    <div class="bg"  data-bg="{{ asset('assets') }}/images/bg/25.jpg" data-scrollax="properties: { translateY: '30%' }"></div>
                    <div class="overlay overlay-bold"></div>
                                        ...
                                        <div class="clients-carousel">
                                            <div class="swiper-container">
                                                <div class="swiper-wrapper">
                                                    <!--client-item-->
                                                    <div class="swiper-slide">
                                                        <a href="#" class="client-item"><img src="{{ asset('assets') }}/images/clients/1.png" alt=""></a>
                                                    </div>
                                                    <!--client-item end-->
                                                    <!--client-item-->
                                                    <div class="swiper-slide">
                                                        <a href="#" class="client-item"><img src="{{ asset('assets') }}/images/clients/2.png" alt=""></a>
                                                    </div>
                                                    <!--client-item end-->
                                                    <!--client-item-->
                                                    <div class="swiper-slide">
                                                        <a href="#" class="client-item"><img src="{{ asset('assets') }}/images/clients/3.png" alt=""></a>
                                                    </div>
                                                    <!--client-item end-->
                                                    <!--client-item-->
                                                    <div class="swiper-slide">
                                                        <a href="#" class="client-item"><img src="{{ asset('assets') }}/images/clients/4.png" alt=""></a>
                                                    </div>
                                                    <!--client-item end-->
                                                    <!--client-item-->
                                                    <div class="swiper-slide">
                                                        <a href="#" class="client-item"><img src="{{ asset('assets') }}/images/clients/5.png" alt=""></a>
                                                    </div>
                                                    <!--client-item end-->
                                                </div>
                                            </div>
                            ...
                            <div class="boxed-container-title">
                                <div class="dec-container">
                                    <div class="boxed-container-title_item">
                                        ...
                                        <p class="has-drop-cap">Con người biết đi là một bản năng. Vì vậy, khi chân còn khỏe, sức còn bền thì chẳng có lý do gì ta ngồi im một chỗ. Hãy đến với chúng tôi!
                                            Khách sạn của chúng tôi không chỉ là một địa điểm nghỉ ngơi mà còn là một thế giới của sự tận hưởng thỏa thích.</p>
                ...
                <div class="content-section dark-bg no-padding column-section hidden-section" data-scrollax-parent="true">
                    <div class="column-wrap-bg right-wrap">
                        <div class="par-elem">
                            <div class="bg"  data-bg="{{ asset('assets') }}/images/bg/23.jpg" data-scrollax="properties: { translateY: '20%' }"></div>
                            <div class="overlay"></div>
                        </div>
                        <div class="column-wrap-bg-text">
                            <h3>Our restaurant</h3>
                            <h4>Want to order food at number? Visit our online store.</h4>
                            <a href="{{ Route('restaurant') }}" class="hero-rsto-link">Visit Our restaurant</a>
                        </div>
                    </div>
                    <div class="column-section-wrap left-column-section" >
                        <div class="container"  >
                            <div class="column-text">
                                            ...
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="event-carousel-item">
                                                        <h4><a href="{{ Route('blog-single') }}">Jazz Band Live Event</a></h4>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="event-carousel-item">
                                                        <h4><a href="{{ Route('blog-single') }}">Wine and Steak Day</a></h4>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="event-carousel-item">
                                                        <h4><a href="{{ Route('blog-single') }}">Freedom Day Celebration</a></h4>
                                ...
                                <a href="{{ Route('blog') }}" class="stg_link">Read all News</a>
                            </div>
                        </div>
                        <div class="map-dec2"></div>
                        <div class="footer-separator fs_sin"><span></span></div>
...
<!-- Mirrored from diamant.kwst.net/site/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Jun 2024 07:14:39 GMT -->
</html>